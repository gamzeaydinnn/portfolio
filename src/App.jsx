  ...
  <nav className="portfolio-navbar">
    <div className="navbar-content">
      ...
      <ul className="navbar-links">
        ...
        <li>
          <a href="#education">Eğitim Bilgilerim</a>
        </li>
      </ul>
...
function App() {
  ...
  const [stokModalIndex, setStokModalIndex] = useState(0);
  const [showTodoModal, setShowTodoModal] = useState(false);
  const [showHepsiburadaModal, setShowHepsiburadaModal] = useState(false);
  const stokModalImages = [
    {
      src: "/images/stok-modal-1.png",
      alt: "Stok Takip Sistemi Ekran 1",
    },
    {
      src: "/images/stok-modal-2.png",
      alt: "Stok Takip Sistemi Ekran 2",
    },
  ];
  return (
    <>
      ...
      {showStokModal && (
        <div className="modal-overlay" onClick={() => setShowStokModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            >
              Hızlı moda sektöründe popüler ürünlerin ve belirli bedenlerin
              stokları saniyeler içinde tükenebilmektedir. Bu durum,
              tüketicilerin istedikleri ürünlere ulaşmak için sürekli olarak web
              sitelerini manuel kontrol etmelerine neden olmaktadır.
              Geliştirdiğim bu proje, bu soruna çözüm olarak doğmuş, kullanıcı
              deneyimini merkeze alan bir otomasyon aracıdır.
              <br />
              <br />
              Sistem, Inditex grubu (Zara, Bershka, Stradivarius vb.)
              markalarına ait ürünleri, kullanıcının belirlediği periyotlarda
              otomatik olarak takip eder. Aranan ürün ve beden stoğa girdiği
              anda, kullanıcıya anlık WhatsApp bildirimi göndererek satın alma
              fırsatını kaçırmamasını sağlar.
            </div>
      ...
      {showTodoModal && (
        <div className="modal-overlay" onClick={() => setShowTodoModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            >
              Bu proje, modern bir web uygulamasının temelini oluşturan backend
              servislerini ve veritabanı operasyonlarını A'dan Z'ye uygulamak
              amacıyla geliştirilmiş full-stack bir görev yönetimi (Todo)
              uygulamasıdır. Sadece bir "yapılacaklar listesi" olmanın ötesinde,
              bu proje; sağlam bir API mimarisi kurma, veritabanı işlemlerini
              yönetme ve endüstri standardı araçlarla API'yi test etme
              yetkinliklerimi sergilemektedir.
              <br />
              <br />
              Uygulama, kullanıcıların görevlerini oluşturmasına,
              görüntülemesine, güncellemesine ve silmesine olanak tanır. Tüm bu
              işlemler, frontend (kullanıcı arayüzü) ve backend (sunucu)
              arasında RESTful API aracılığıyla iletişim kurarak
              gerçekleştirilir ve veriler kalıcı olarak MongoDB'de saklanır.
            </div>
            <div className="project-tags">
              <span>JavaScript</span>
              <span>Node.js</span>
      ...
      {showHepsiburadaModal && (
        ...
        >
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            >
              <h2 style={{ color: "#7c4dff", margin: 0, flex: 1 }}>
                Hepsiburada Alışveriş Otomasyonu
              </h2>
              <button
                aria-label="Kapat"
                style={{
            ...
            >
              Node.js tabanlı Playwright kullanarak Hepsiburada'da uçtan uca bir
              alışveriş senaryosu simüle edilmiştir. Proje, kritik e-ticaret
              fonksiyonlarını otomatize testler ile doğrular.
              <br />
              <br />
              Otomasyon, ürün arama, sepete ekleme ve ödeme adımlarını
              Playwright ile test etmektedir. E-ticaret süreçlerinin güvenli ve
      ...
      <div className="portfolio-bg">
        <div className="portfolio-container">
          ...
          <p className="portfolio-desc">
            Modern programlama dilleri ile{" "}
            <span className="portfolio-strong">etkileyici çözümler</span>{" "}
            geliştiren bilgisayar mühendisliği öğrencisi
          </p>
          ...
          <div className="portfolio-buttons">
            <button className="portfolio-main-btn">Portfolyomu İncele</button>
            <a
          ...
          <section className="about-section" id="about">
            <div className="about-card about-fade-in">
              ...
              <p className="about-text">
                Merhaba! Ben Gamze Aydın. Modern ve yenilikçi yazılım çözümleri
                üretmeyi seven, kullanıcı odaklı ve detaylara önem veren bir
                geliştiriciyim. Java, JavaScript, React ve Node.js gibi
                teknolojilerle projeler geliştiriyorum. Takım çalışmasına
                yatkın, öğrenmeye ve yeni teknolojilere açık biriyim.
              </p>
            </div>
            <div className="about-feature-list">
              ...
              >
                ...
                <p className="feature-desc">
                  Temiz, okunabilir ve sürdürülebilir kod yazma konusunda
                  tutkulu
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="feature-desc">
                  Kullanıcı deneyimini ön planda tutan tasarım anlayışı
                </p>
              </div>
              <div
                className="feature-card feature-anim"
              ...
              >
                ...
                <p className="feature-desc">
                  Hızlı ve optimize edilmiş uygulamalar geliştirme
                </p>
              </div>
              <div
                className="feature-card feature-anim"
              ...
              >
                ...
                <p className="feature-desc">
                  Teknolojiye olan tutkum ve sürekli öğrenme isteği
                </p>
              </div>
              <div
                className="feature-card feature-anim"
              ...
              >
                ...
                <p className="feature-desc">
                  Hedef odaklı çalışma ve sonuç alma becerileri
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="experiences-section" id="experiences">
            <h2 className="experiences-title">Deneyimlerim</h2>
            <p className="experiences-desc">
              Profesyonel gelişimime katkı sağlayan deneyimlerim
            </p>
            <div className="experiences-list">
              ...
              >
                ...
                <div className="experience-role">
                  Fullstack Developer Stajyeri
                </div>
                <div className="experience-content">
                  <p style={{ marginTop: "1rem" }}>
                    React tabanlı stok takip uygulaması yaptım. Hem backend hem
                    frontend tarafında yer aldım.
                  </p>
                  <div className="experience-achievements">
                    ...
                    <ul>
                      <li>React tabanlı stok takip uygulaması yaptım</li>
                      <li>
                        Backend ve frontend geliştirme süreçlerinde aktif rol
                        aldım
                      </li>
                      <li>Stok yönetimi ve raporlama modülleri geliştirdim</li>
                    </ul>
                  </div>
                  <div
              ...
              >
                ...
                <div className="experience-content">
                  <p>
                    Web tabanlı uygulama geliştirme süreçlerinde görev aldım.
                    Frontend ve backend geliştirme, test otomasyonu ve kullanıcı
                    arayüzü iyileştirmeleri üzerine çalıştım.
                  </p>
                  <div className="experience-achievements">
                    <span style={{ color: "#4ea1f7", fontWeight: 600 }}>
                      Başarılarım:
                    ...
                    <ul>
                      <li>React tabanlı todoapp uygulaması geliştirdim</li>
                      <li>Test otomasyon süreçlerini iyileştirdim</li>
                      <li>Kullanıcı arayüzü performansını artırdım</li>
                    </ul>
                  </div>
          ...
          <section className="projects-section" id="projects">
            ...
            <p className="projects-desc">
              JavaScript ve Node.js ile geliştirdiğim projeler
            </p>
            <h3 className="projects-featured">Öne Çıkan Projeler</h3>
            <div className="projects-list">
              ...
              >
                ...
                <div className="project-content">
                  <h4 className="project-title">Stok Takip Sistemi</h4>
                  <p className="project-desc">
                    Inditex grubu (Zara, Bershka, Stradivarius vb.) markalarına
                    ait ürünlerin stoklarını otomatik takip eden ve WhatsApp ile
                    bildirim gönderen bir otomasyon sistemi.
                  </p>
                  <div className="project-tags">
                    <span>JavaScript</span>
                    <span>Node.js</span>
              ...
              >
                ...
                <div className="project-content">
                  <h4 className="project-title">Yapılacaklar Uygulaması</h4>
                  <p className="project-desc">
                    Modern web uygulamalarında backend ve veritabanı
                    operasyonlarını uçtan uca uygulamayı amaçlayan, görev
                    yönetimi sağlayan full-stack bir todo uygulaması.
                  </p>
                  <div className="project-tags">
                    <span>JavaScript</span>
                    <span>Node.js</span>
              ...
              >
                ...
                <div className="project-content">
                  ...
                  <p className="project-desc">
                    Node.js tabanlı Playwright kullanarak Hepsiburada'da uçtan
                    uca bir alışveriş senaryosu simüle edilmiştir. Proje, kritik
                    e-ticaret fonksiyonlarını otomatize testler ile doğrular.
                  </p>
                  <div className="project-tags">
                    <span>Playwright</span>
                    <span>Node.js</span>
          ...
          >
            ...
            >
              ...
              >
                Web teknolojileri, yazılım geliştirme, veri yapıları ve
                algoritma analizi alanlarında kapsamlı eğitim aldım.{" "}
                <b>Java tabanlı yoğun bir eğitim</b> ile frontend ve backend
                teknolojilerine odaklandım.
              </div>
              <div
                style={{
                  display: "flex",
